...
class Transaccion(models.Model):
    ...
    movimientos =models.ManyToManyField ('movimiento.Movimiento',models.CASCADE, null=False, blank=False)
    monto_total = models.DecimalField(decimal_places=2,null=False,blank=False)
    metodo_envio= models.IntegerField(max_length=1,null=False,choices=ENVIO_CHOICE,default=ENVIO_CHOICE[0][0])
    direccion= models.ForeignKey('direccion.Direccion',models.CASCADE,null=True)
    estado = models.IntegerField(max_length=1,null=False, blank=False,choices=ESTADO_CHOICE,default=ESTADO_CHOICE[0][0])
